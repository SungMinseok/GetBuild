...
powershell Compress-Archive -Path dist\QuickBuild.exe, dist\QuickBuild_updater.exe, branch_settings.json, version.txt, ico.ico, qss -DestinationPath QuickBuild.zip
